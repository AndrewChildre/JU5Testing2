...
import com.ac.JU5Testing2.service.BankService
...
class BankController(private val service : BankService) {
    ...
    fun duplicateAccountNumber(e: java.lang.IllegalArgumentException): ResponseEntity<String> = ResponseEntity(e.message, HttpStatus.BAD_REQUEST)
    @GetMapping
    ...
    fun addBank (@RequestBody bank: Bank):Bank = service.newBank(bank)
